<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="title.aspx.cs" Inherits="GTF.title" %>
...
<li></li> <li></li><li></li><li></li> <li></li><li></li><li></li><li></li><li></li> <li></li><li></li><li></li> <li></li><li></li><li></li><li></li><li></li> <li></li><li></li><li></li> <li></li> <li></li><li></li><li></li> <li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li>
      ...
      <div class="nav-links" id="navLinks">
         ...
         <section class="header1">
              <div class="center">
                  <asp:Image ID="Image1" runat="server" CssClass="Image1"  ImageUrl="~/stock/ga1.jpg" Height="368px" Width="800px" />      
                </div>
                 
                        <table style="width: 800px; height:200px; margin-top:-150px; margin-left:250px; margin-right:-600px; background-color:white;" border="0" >
                            <tr>
                                <td>Title :</td>
