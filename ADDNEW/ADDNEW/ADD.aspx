<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADD.aspx.cs" Inherits="ADDNEW.ADD" %>
         ...
         <section class="header1">
              <div class="center" >
                    ...
                    <h3>ADD NEW ARTICLE</h3>
                        ...
                        <table style="width: 800px; height:200px; margin-top:50px; margin-left:250px; margin-right:-600px; background-color:white;" border="0" >
                            <tr>
                                <td>Title :</td>
                            ...
                            <tr>
                                <td>Photo  :  </td>
                                <td> <asp:Image ID="Image2" runat="server" CssClass="Image2"  ImageUrl="~/stock/ga1.jpg" Height="29px" Width="225px" />      </td>
